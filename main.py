...
layout: list = [
    [sg.Text('Calculator', size=(50, 1), justification='right', background_color="#272533",
...
window: object = sg.Window('Calculator', layout=layout, element_justification='right', margins=(10, 20),
